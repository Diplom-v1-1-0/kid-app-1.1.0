...
class FlipCardGane extends StatefulWidget {
  late Level _level;
  FlipCardGane(this._level, {super.key});
  @override
...
class _FlipCardGaneState extends State<FlipCardGane> {
  ...
  late Level _level;
  int _time = 5;
  int _left = 0; // Initialize _left with a default value
  bool _isFinished = false; // Initialize _isFinished with a default value
  List<String> _data = [];
  ...
  _FlipCardGaneState(Level level);
