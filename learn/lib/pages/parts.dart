...
class _PartsPagePageState extends State<PartsPage> {
  ...
  String getDescription(String name) {
    switch (name) {
      case "Eye":
        return "Нүд бол гэрэлд хариу үйлдэл үзүүлж, алсыг харахад тусалдаг эрхтэн юм.";
      case "Уруул":
        return "Ярилцаж, инээмсэглэхэд тусална. Чихэрлэг, исгэлэн зүйлийг амтлах болно. Уруул нь аманд харагдах биеийн хэсэг юм.";
      case "Ankle":
